 ...
 * @author Shivam
 */
public class SportsKitServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SportsKitServlet</title>");            
            out.println("</head>");
            out.println("<body bgcolor='00FF00'>");
            out.println("<center>");
            out.println("<h1><u>"+greet+"</h2>");
            out.println("<span style='color:red'><b>Admin SportsKit Gallery!!</span>");
            out.println("<div style='background-color:aqua'><hr>");
