...
public class SmartphonesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SmartphonesServlet</title>");            
            out.println("</head>");
               out.println("<body bgcolor='yellow'>");
            out.println("<center>");
            out.println("<h1><u>"+greet+"</h1>");
            out.println("<span style='color:blueviolet'><b>Admin Smartphones Gallery!!</span>");
             out.println("<div style='background-color:lightsalmon'><hr>");
